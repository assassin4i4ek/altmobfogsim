...
//    Config.MAX_SIMULATION_TIME = 1000
//    Experiment1(null, false, false,1000,
//            doubleArrayOf(10.0), intArrayOf(1, 2, 4, 8, 16), 4, booleanArrayOf(false)).start()
//    Experiment2(null, false,false,1000,
//            doubleArrayOf(5.0), intArrayOf(1), 2, booleanArrayOf(false)).start()
    Experiment3(null, false, false, 1000,
            doubleArrayOf(5.0), intArrayOf(1), 2, booleanArrayOf(false)).start()
//    Experiment4(null, false, true, 1000,
//            doubleArrayOf(5.0), intArrayOf(2), 4, booleanArrayOf(false)).start()
}