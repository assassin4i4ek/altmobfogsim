    ...
    fun test4() {
        ...
        val serv1 = createMigratingNetworkDevice("Serv1", 10.0, 1000.0, 1000.0, 0.1, 0.01,
                CentralizedMapoModel(1.0, true, listOf(MinCostObjective(), MinProcessingTimeObjective()), MinMaxNormalizer(), 123).apply {
                    allowMigrationForModule("concentration_calculator")
                }
        )
        val serv2 = createMigratingNetworkDevice("Serv2", 10.0, 1000.0, 1000.0, 0.1, 0.01,
                CentralizedMapoModel(1.0, false, listOf(MinCostObjective(), MinProcessingTimeObjective()), MinMaxNormalizer(), 123)
        )
        fogDeviceList.addAll(listOf(mob, serv1, serv2))
